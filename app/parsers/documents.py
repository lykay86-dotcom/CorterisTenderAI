...
def classify_document(name: str, text: str) -> str:
    ...
    rules = [
        ("Проект договора", ["проект договора", "контракт"]),
        ("Техническое задание", ["техническое задание", "описание объекта закупки"]),
        ("Смета", ["локальная смета", "сметный расчет", "ведомость объемов"]),
        ("Требования к заявке", ["состав заявки", "инструкция участнику"]),
        ("Спецификация", ["спецификация", "перечень оборудования"]),
    ]
