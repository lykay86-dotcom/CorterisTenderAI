...
class TenderFullAnalysisDialog(QDialog):
    ...
    def __init__(
        ...
        *,
        ...
        self.stages.setObjectName("FullAnalysisStagesTable")
        self.stages.setAccessibleName("Этапы полного анализа тендера")
        self.stages.setAccessibleDescription("Этап, состояние и безопасные подробности выполнения")
        self.stages.setTabKeyNavigation(False)
        ...
        self.tabs.setObjectName("FullAnalysisTabs")
        self.tabs.setAccessibleName("Результаты полного анализа тендера")
