"""Tests for Crash Report Center navigation."""
...
def test_system_health_center_emits_crash_reports_request(
    tmp_path,
) -> None:
    _app()
    ...
    assert dialog.crash_reports_button.text() == "Crash-reports…"
