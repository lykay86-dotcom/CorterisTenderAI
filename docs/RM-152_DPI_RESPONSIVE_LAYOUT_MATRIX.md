...
| DPI-1920-100-D/L | 1920x1080 | 100% | dark/light | plus all states | BLOCKED; keyboard worked in both themes; white native fallback strips were removed on `81A11C...A866`; text-only UIA then found mojibake, and UTF-8 fixed build `11E59D...066F0` awaits native launch; all states remain incomplete |
