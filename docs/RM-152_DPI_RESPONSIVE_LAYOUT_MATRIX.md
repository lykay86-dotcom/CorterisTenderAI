...
| DPI-1920-100-D/L | 1920x1080 | 100% | dark/light | plus all states | BLOCKED; keyboard worked in both themes; white native fallback strips found on the original build were confirmed removed on fixed build `81A11C...A866`; all states remain incomplete |
