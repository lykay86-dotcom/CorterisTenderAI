...
| DPI-1920-150-D/L | 1920x1080 | 150% | dark/light | plus all states | BLOCKED; Windows UIA confirmed 150% and exact-build restart; UIA exposed 166 current elements/zero mojibake lines; owner confirmed no clipping/overlap, clean dark/light switching, and Tab/Shift+Tab without a trap; Windows UIA confirmed 100% restoration after the run; all semantic states incomplete |
