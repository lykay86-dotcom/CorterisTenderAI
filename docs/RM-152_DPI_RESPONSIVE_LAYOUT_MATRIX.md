...
| DPI-1920-100-D/L | 1920x1080 | 100% | dark/light | plus all states | FAIL; keyboard worked in both themes, but dark theme exposed white native fallback strips on the original build; fixed build `81A11C...A866` awaits native visual rerun; all states incomplete |
