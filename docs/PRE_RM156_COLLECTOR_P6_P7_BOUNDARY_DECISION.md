...
- PR #144 head `ddd3d37a7f13a10d45b29a1c3c5496f38ff9e1e8`;
- PR-head Quality Gate `29979195455`: jobs `89118148283` (Python 3.12) и `89118148873`
  (Python 3.13) успешны после controlled rerun failed Python 3.12 job;
- merge commit `e54fd46d6525e378cd90795f35ae144f00fffe31`;
- exact merge-SHA Quality Gate `29979715877`: jobs `89118819142` (Python 3.12) и
  `89118819085` (Python 3.13) успешно прошли fresh run, включая dependency audit.

Только после exact success создан отдельный B2B-Center access-audit worktree от merge commit.
