...
| NATIVE-1920-150-D/L | 1920x1080, 150%, dark/light | BLOCKED | Windows UIA confirmed 150% and exact-build restart with 166 current elements/zero mojibake lines; owner confirmed no clipping/overlap, clean dark/light switching, and Tab/Shift+Tab without a trap; complete states and Narrator journey incomplete |
