...
| NATIVE-1920-100-D/L | 1920x1080, 100%, dark/light, all semantic states | FAIL | keyboard worked in both themes, but dark theme exposed white native fallback strips; source fix awaits rebuilt exact-artifact rerun; all states and Narrator incomplete |
