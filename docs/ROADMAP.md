...
## RM-126 — acceptance аудита (до post-merge closeout)
...
- RM-126 остаётся `IN PROGRESS`. Перевод в `DONE` и активация RM-127 разрешены только отдельным
  docs-only closeout после merge audit PR и успешного post-merge Windows Quality Gate.
